...
export function sortAnswersByLatest(answers) {
    answers = [...answers];
    answers.sort((a, b) => new Date(b.ans_date_time) - new Date(a.ans_date_time));
    return answers;
}

export function sortCommentsByLatest(comments) {
    comments = [...comments];
    comments.sort((a, b) => new Date(b.com_date_time) - new Date(a.com_date_time));
    return comments;

}

export function createGroup(arr, chunkSize) {
    arr = [...arr];
    const chunks = [];
